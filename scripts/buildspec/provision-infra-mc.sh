...
MC_CONFIG_FILE="deploy/${ENVIRONMENT:-staging}/${TARGET_REGION}/terraform/management/${MANAGEMENT_ID}.json"
...
export TF_VAR_sector="${SECTOR:-${ENVIRONMENT}}"
